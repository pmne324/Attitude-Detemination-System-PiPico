...
class HMC5883L:
    ...
    def __init__(self, scl=9, sda=8, address=0x77, gauss='1.9', declination=(0, 0)):
        ...
        i2c.writeto_mem(0x77, 0x00, pack('B', 0b111000))

        # Configuration register B:
        reg_value, self.gain = self.__gain__[gauss]
        i2c.writeto_mem(0x77, 0x01, pack('B', reg_value))

        # Set mode register to continuous mode.
        i2c.writeto_mem(0x77, 0x02, pack('B', 0x00))
        i2c.stop()
    ...
    def read(self):
        ...
        self.i2c.readfrom_mem_into(0x77, 0x03, data)
